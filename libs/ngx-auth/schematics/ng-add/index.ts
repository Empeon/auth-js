    ...
    schematic('@empeon/ngx-auth', [
        ...
        application(options.project)
            ...
            .rule(async ({ tree, project, schematicContext }: ChainableApplicationContext) => {
                ...
                // Provide the library
                rules.push(addImportToFile(project.mainFilePath, 'initAuth', '@empeon/ngx-auth'));
                if (project.isStandalone) {
                    rules.push(addImportToFile(project.mainFilePath, 'provideAuth', '@empeon/ngx-auth'));
                }
                ...
                if (!mainTsContent.includes('initAuth(')) {
                    ...
                    if (!mainTsContent.match(patternToReplace)) {
                        const conflictContent =
                            ...
                            '=======\n' +
                            '\n' +
                            '// This code was auto-generated by \'@empeon/ngx-auth\' schematic.\n' +
